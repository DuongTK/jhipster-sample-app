...
@RestController
@RequestMapping("/api/jhipster-sample-app-kafka")
public class JhipsterSampleAppKafkaResource {
    private final Logger log = LoggerFactory.getLogger(JhipsterSampleAppKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public JhipsterSampleAppKafkaResource(KafkaProperties kafkaProperties) {
