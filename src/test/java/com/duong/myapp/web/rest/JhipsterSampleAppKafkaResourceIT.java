...
class JhipsterSampleAppKafkaResourceIT {
    ...
    void setup() {
        ...
        JhipsterSampleAppKafkaResource kafkaResource = new JhipsterSampleAppKafkaResource(kafkaProperties);
    ...
    void producesMessages() throws Exception {
        restMockMvc
            .perform(post("/api/jhipster-sample-app-kafka/publish/topic-produce?message=value-produce"))
    ...
    void consumesMessages() throws Exception {
        ...
        MvcResult mvcResult = restMockMvc
            .perform(get("/api/jhipster-sample-app-kafka/consume?topic=topic-consume"))
            .andExpect(status().isOk())
